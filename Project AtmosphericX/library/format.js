...
class format {
    ...
    registerEvent(data) {
        try {
            let audioToUse = configurations['DEFINED_SOUNDS']['BEEP']
            let beepOnly = configurations['BEEP_ONLY']
            let excludedEvents = (configurations['EXCLUDED_EVENTS'])
            ...
            let eventAction = configurations['DEFINED_WARNINGS'][eventName]
            if (eventAction != undefined) {
                ...
                let gif = configurations['DEFINED_BANNERS'][eventName]
                ...
                if (eventName == triggeredBy) {
                    ...
                    if (beepOnly == true) {
                        if (!excludedEvents.includes(eventName)) {
                            audioToUse = configurations['DEFINED_SOUNDS']['BEEP']
                            onlyBeep = true
                        }
                    }
                ...
                let unknownEvent = configurations['DEFINED_WARNINGS']['UNK']
                let onlyBeep = false
                let ignoreWarning = false
