    ...
    nextRun = async function(isNWWS=undefined, forceFallback=false) {
        return new Promise(async (resolve, reject) => {
            ...
            let handles = [
                ...
                {name: 'mPingReports', handle: sources.miscellaneous_sources.mping_reports, timer: sources.miscellaneous_sources.mping_reports.cache_time, contradictions: [`IEMReports`, `GRLevelXReports`, `NoaaWeatherWireServiceLsr`], pointer: `genericRequest`},
                {name: 'IEMReports', handle: sources.miscellaneous_sources.iem_local_storm_reports, timer: sources.miscellaneous_sources.iem_local_storm_reports.cache_time, contradictions: [`mPingReports`, `GRLevelXReports`, `NoaaWeatherWireServiceLsr`], pointer: `featureRequest`},
                {name: 'GRLevelXReports', handle: sources.miscellaneous_sources.grlevelx_reports, timer: sources.miscellaneous_sources.grlevelx_reports.cache_time, contradictions: [`mPingReports`, `IEMReports`, `NoaaWeatherWireServiceLsr`], pointer: `genericRequest`},
