    ...
    nextRun = async function(isNWWS = undefined, forceFallback = false) {
        return new Promise(async (resolve) => {
            ...
            let handles = [
                ...
                { name: 'IEMReports', handle: sources.miscellaneous_sources.iem_local_storm_reports, timer: sources.miscellaneous_sources.iem_local_storm_reports.cache_time, contradictions: [ 'GRLevelXReports', 'SpotterNetworkReports'], pointer: 'featureRequest' },
                { name: 'GRLevelXReports', handle: sources.miscellaneous_sources.grlevelx_reports, timer: sources.miscellaneous_sources.grlevelx_reports.cache_time, contradictions: [ 'IEMReports', 'SpotterNetworkReports'], pointer: 'genericRequest' },
                { name: 'SpotterNetworkReports', handle: sources.miscellaneous_sources.spotter_network_reports, timer: sources.miscellaneous_sources.spotter_network_reports.cache_time, contradictions: ['IEMReports', 'GRLevelXReports'], pointer: 'genericRequest' },
